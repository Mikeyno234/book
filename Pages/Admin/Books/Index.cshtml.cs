...
namespace shop.Pages.Admin.Books
{
...

    {
		...
		public void OnGet()
        {
			...
			try
            {
                string connnectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=betshop;Integrated Security=True";
                ...
                using (SqlConnection connnection = new SqlConnection(connnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand(sqlCount, connnection))
                    {

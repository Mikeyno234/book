...
namespace shop.Pages.Auth
{
    [BindProperties]
    public class LoginModel : PageModel
    {
        [Required(ErrorMessage = "Ther Email is required"), EmailAddress]
        ...
        public void OnPost()
        {
            ...
            try
            {
                string connectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=betshop;Integrated Security=True";
                    ...
                    using(SqlCommand command = new SqlCommand(sql, connection))
                    {
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            if(reader.Read())
                            {
                                ...
                                string created_at = reader.GetDateTime(8).ToString("MM/dd/yyy");
                                    ...
                                    || result == PasswordVerificationResult.SuccessRehashNeeded)
                                {
                                    ...
                                    //the user is authenticated successfully => redirect to the homw page
                                    Response.Redirect("/");
                                }
